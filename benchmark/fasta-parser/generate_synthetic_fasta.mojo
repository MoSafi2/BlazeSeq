...
from blazeseq.utils import generate_synthetic_fasta_buffer, compute_num_fasta_reads_for_size
...
fn main() raises:
    ...
    var num_reads = compute_num_fasta_reads_for_size(target_size, MIN_LEN, MAX_LEN, LINE_WIDTH)
    print("Generating", num_reads, "records (~", size_gb, "GB, avg 2000 bp, line_width=60)...")
    var data = generate_synthetic_fasta_buffer(num_reads, MIN_LEN, MAX_LEN, LINE_WIDTH)
