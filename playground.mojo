...
#TODO: Convert this to a real Struct
...
fn main() raises:
    ...
    while True:
        ...
        while True:
            ...
            last_valid_pos = last_valid_pos + x.total_length #Should be update before any mutating operations on the Record that can change the length
...
@always_inline
fn next_line_iter(
    borrowed s: String, start: Int = -1
) -> String:  # String: Slice 4mb, 75 µs
...
@always_inline
fn next_line_iter_tesnor(
    borrowed s: Tensor[DType.int8], start: Int = -1
) -> Tensor[DType.int8]:  # Tensor: Slice 4mb, 4 µs
