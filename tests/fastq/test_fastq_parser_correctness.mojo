...
def invalid_file_test_fun(file: String, msg: String = "") raises:
...
def valid_file_test_fun(file: String, schema: String = "generic") raises:
    var parser = FastqParser[FileReader](FileReader(test_dir + file), schema)
    for _ in parser.records():
        pass


def valid_file_test_fun_ref(file: String, schema: String = "generic") raises:
...
def invalid_file_test_fun_ref(file: String, msg: String = "") raises:
...
def valid_file_test_fun_gz(file_gz: String, schema: String = "generic") raises:
...
def valid_file_test_fun_gz_ref(
...
def test_valid_example_fastq_gz() raises:
    valid_file_test_fun_gz("example.fastq.gz")


def test_valid_example_fastq_gz_ref() raises:
    valid_file_test_fun_gz_ref("example.fastq.gz")


def test_valid_example_fastq_bgz() raises:
    valid_file_test_fun_gz("example.fastq.bgz")


def test_valid_example_fastq_bgz_ref() raises:
    valid_file_test_fun_gz_ref("example.fastq.bgz")


def test_valid_example_dos_fastq_bgz() raises:
    valid_file_test_fun_gz("example_dos.fastq.bgz")


def test_valid_example_dos_fastq_bgz_ref() raises:
